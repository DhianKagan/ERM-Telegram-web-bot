...
const taskPointsInput_1 = require("../utils/taskPointsInput");
...
let TasksController = class TasksController {
    constructor(service, reportGenerator) {
        ...
        this.list = async (req, res) => {
            ...
            if (['admin', 'manager'].includes(req.user.role || '')) {
                ...
                if (statusValues.length) {
                    ...
                    tasks = tasks.filter((task) => typeof task.status === 'string'
            ...
            (0, sendCached_1.sendCached)(req, res, { tasks: normalizedTasks, users, total });
        };
        ...
        this.update = [
            ...
            async (req, res) => {
                ...
                const currentStatus = typeof previousTask.status === 'string'
                    ? previousTask.status
                    : undefined;
                const isCreator = Number.isFinite(Number((_b = req.user) === null || _b === void 0 ? void 0 : _b.id)) &&
                    Number(previousTask.created_by) === Number((_c = req.user) === null || _c === void 0 ? void 0 : _c.id);
                ...
                const docId = typeof task._id === 'object' &&
                    task._id !== null &&
                    'toString' in task._id
                    ? task._id.toString()
                    : String((_d = task._id) !== null && _d !== void 0 ? _d : '');
                if (docId) {
        ...
        this.transportOptions = async (_req, res) => {
            ...
            const positionIds = positions
                .map((item) => ((item === null || item === void 0 ? void 0 : item._id) ? String(item._id) : null))
            ...
            res.json({
                ...
                vehicles: vehicles.map((vehicle) => ({
                    ...
                    transportType: typeof vehicle.transportType === 'string' &&
            ...
            if (kindParam === 'request') {
                ...
                const list = admins
                    ...
                    return ({
                        ...
                        telegram_username: (_a = candidate.username) !== null && _a !== void 0 ? _a : null,
                    });
                });
                res.json(list);
                return;
        ...
        this.remove = async (req, res) => {
            ...
            const attachmentsChatValue = (_a = photosChatId !== null && photosChatId !== void 0 ? photosChatId : groupChatId) !== null && _a !== void 0 ? _a : normalizedGroupChatId;
            ...
            const actorId = typeof ((_b = req.user) === null || _b === void 0 ? void 0 : _b.id) === 'number' && Number.isFinite(req.user.id)
                ? req.user.id
                : undefined;
    ...
    sendPointsProblem(error, req, res) {
        var _a;
        ...
        if (error.code === 'invalid_segment') {
            const details = (_a = error.details) !== null && _a !== void 0 ? _a : {};
    ...
    async applyPointsPayload(payload, req, res) {
        try {
            const preparedPoints = await (0, taskPointsInput_1.prepareIncomingPoints)(payload.points);
            if (Array.isArray(payload.points) || preparedPoints.length) {
                payload.points = preparedPoints;
            }
            return true;
        }
        catch (error) {
            if (error instanceof taskPointsInput_1.TaskPointsValidationError) {
    ...
    normalizeTaskResponse(task) {
        ...
        const plain = typeof task.toObject === 'function'
            ? task.toObject()
            : { ...task };
        (0, taskPoints_1.syncTaskPoints)(plain);
        return plain;
    }
    ...
    isConversationStartRequiredError(error) {
        if (!error || typeof error !== 'object') {
            return false;
        }
        const response = error.response;
    ...
    normalizeInlineImages(inline) {
        if (!(inline === null || inline === void 0 ? void 0 : inline.length))
            return [];
        const result = [];
    ...
    async sendTaskMessageWithPreview(chat, message, _sections, media, keyboard, topicId, options) {
        const skipAlbum = (options === null || options === void 0 ? void 0 : options.skipAlbum) === true;
        const cache = new Map();
        const keyboardMarkup = this.extractKeyboardMarkup(keyboard);
        const preview = media.previewImage;
        const previewUrl = preview === null || preview === void 0 ? void 0 : preview.url;
        ...
        const mainMessageId = response === null || response === void 0 ? void 0 : response.message_id;
        ...
        const sendSupplementaryChunk = async (chunk) => {
            ...
            try {
                ...
                if (extraMessage === null || extraMessage === void 0 ? void 0 : extraMessage.message_id) {
        ...
        if (!skipAlbum && albumCandidates.length > 1) {
            try {
                ...
                const mediaGroup = await Promise.all(selected.map(async (item, index) => {
                    ...
                    const captionValue = index === 0 ? albumCaption : ((_a = item.caption) !== null && _a !== void 0 ? _a : undefined);
                    if (captionValue) {
                        descriptor.caption =
                            index === 0 ? captionValue : (0, mdEscape_1.default)(captionValue);
                ...
                if (Array.isArray(mediaResponse) && mediaResponse.length) {
                    mediaResponse.forEach((entry) => {
                        if (typeof (entry === null || entry === void 0 ? void 0 : entry.message_id) === 'number') {
            ...
            try {
                ...
                if (photoResponse === null || photoResponse === void 0 ? void 0 : photoResponse.message_id) {
    ...
    async ensurePhotoWithinLimit(info) {
        try {
            ...
            return compressed !== null && compressed !== void 0 ? compressed : current;
        }
        catch (error) {
    ...
    async createCompressedPhoto(info) {
        ...
        try {
            ...
            const baseWidth = (_a = metadata.width) !== null && _a !== void 0 ? _a : null;
            const hasAlpha = metadata.hasAlpha === true;
            let width = baseWidth !== null && baseWidth !== void 0 ? baseWidth : null;
            let quality = 90;
            let buffer = null;
    ...
    async updateTaskAlbumKeyboard(chatId, messageId, taskId, status, kind, albumLink) {
        var _a;
        try {
            const editMarkup = typeof ((_a = bot_1.bot === null || bot_1.bot === void 0 ? void 0 : bot_1.bot.telegram) === null || _a === void 0 ? void 0 : _a.editMessageReplyMarkup) === 'function'
    ...
    extractPhotoErrorCode(error) {
        ...
        if (typeof (response === null || response === void 0 ? void 0 : response.description) === 'string') {
    ...
    areNormalizedAttachmentsEqual(previous, next) {
        ...
        return previous.every((item, index) => {
            ...
            if (item.kind === 'image' && candidate.kind === 'image') {
                return ((_a = item.caption) !== null && _a !== void 0 ? _a : '') === ((_b = candidate.caption) !== null && _b !== void 0 ? _b : '');
            }
            return true;
        });
    }
    ...
    buildPhotoAlbumIntro(task, options) {
        ...
        const text = title ? `*${(0, mdEscape_1.default)(title)}*` : 'Фото по задаче';
        const messageLink = (_a = options.messageLink) !== null && _a !== void 0 ? _a : null;
    ...
    async updateTaskTelegramFields(taskId, set, unset, guard) {
        ...
        try {
            ...
            const matched = (typeof result === 'object' &&
                result !== null &&
    ...
    async sendTaskAttachments(chat, attachments, topicId, replyTo, cache) {
        ...
        const localPhotoInfoCache = cache !== null && cache !== void 0 ? cache : new Map();
        ...
        const sendSingleImage = async (current) => {
            ...
            const sendPhotoAttempt = async () => {
                ...
                if (response === null || response === void 0 ? void 0 : response.message_id) {
            ...
            while (pendingImages.length) {
                ...
                try {
                    ...
                    response.forEach((message) => {
                        if (message === null || message === void 0 ? void 0 : message.message_id) {
        ...
        for (const attachment of attachments) {
            ...
            if (attachment.kind === 'unsupported-image') {
                try {
                    ...
                    console.error('Не удалось отправить неподдерживаемое изображение как документ', (_a = attachment.mimeType) !== null && _a !== void 0 ? _a : 'unknown', (_b = attachment.name) !== null && _b !== void 0 ? _b : attachment.url, error);
                }
                continue;
            }
    ...
    async syncAttachmentMessages(chat, previous, next, messageIds, topicId, replyTo, cacheOverride, previewMessageIds) {
        ...
        const previewIdSet = new Set((previewMessageIds !== null && previewMessageIds !== void 0 ? previewMessageIds : []).filter((value) => typeof value === 'number' && Number.isFinite(value)));
        ...
        const cache = cacheOverride !== null && cacheOverride !== void 0 ? cacheOverride : new Map();
        const result = [];
        ...
        for (let index = 0; index < limit; index += 1) {
            ...
            if (attachment.kind === 'image') {
                ...
                const previousCaption = previousAttachment && previousAttachment.kind === 'image'
                    ? ((_a = previousAttachment.caption) !== null && _a !== void 0 ? _a : '')
                    : '';
                const nextCaption = (_b = attachment.caption) !== null && _b !== void 0 ? _b : '';
            ...
            if (attachment.kind === 'unsupported-image') {
                ...
                const previousCaption = (_c = previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.caption) !== null && _c !== void 0 ? _c : '';
                const previousMime = (_d = previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.mimeType) !== null && _d !== void 0 ? _d : '';
                const previousName = (_e = previousEntry === null || previousEntry === void 0 ? void 0 : previousEntry.name) !== null && _e !== void 0 ? _e : '';
                const nextCaption = (_f = attachment.caption) !== null && _f !== void 0 ? _f : '';
                const nextMime = (_g = attachment.mimeType) !== null && _g !== void 0 ? _g : '';
                const nextName = (_h = attachment.name) !== null && _h !== void 0 ? _h : '';
                const urlChanged = previousUrl !== attachment.url;
                const captionChanged = previousCaption !== nextCaption;
                ...
                try {
                    ...
                    console.error('Не удалось обновить вложение неподдерживаемого изображения', (_j = attachment.mimeType) !== null && _j !== void 0 ? _j : 'unknown', (_k = attachment.name) !== null && _k !== void 0 ? _k : attachment.url, error);
                    return null;
                }
                continue;
            }
    ...
    isMessageNotModifiedError(error) {
        ...
        const response = rawResponse && typeof rawResponse === 'object'
            ? rawResponse
            : null;
        const descriptionRaw = (_b = (_a = response === null || response === void 0 ? void 0 : response.description) !== null && _a !== void 0 ? _a : (typeof record.description === 'string' ? record.description : null)) !== null && _b !== void 0 ? _b : null;
    ...
    isMessageMissingOnEditError(error) {
        ...
        const response = rawResponse && typeof rawResponse === 'object'
            ? rawResponse
            : null;
        const errorCode = (_a = response === null || response === void 0 ? void 0 : response.error_code) !== null && _a !== void 0 ? _a : (typeof record.error_code === 'number' ? record.error_code : null);
        if (errorCode !== 400) {
            return false;
        }
        const descriptionRaw = (_c = (_b = response === null || response === void 0 ? void 0 : response.description) !== null && _b !== void 0 ? _b : (typeof record.description === 'string' ? record.description : null)) !== null && _c !== void 0 ? _c : null;
    ...
    async broadcastTaskSnapshot(task, actorId, options) {
        ...
        const docId = typeof task._id === 'object' &&
            ...
            'toString' in task._id
            ? task._id.toString()
            : String((_a = task._id) !== null && _a !== void 0 ? _a : '');
        if (!docId)
            return;
        const plain = (typeof task.toObject === 'function' ? task.toObject() : task);
        const previousPlain = (_b = options === null || options === void 0 ? void 0 : options.previous) !== null && _b !== void 0 ? _b : null;
        const action = (_c = options === null || options === void 0 ? void 0 : options.action) !== null && _c !== void 0 ? _c : 'создана';
        const noteRaw = typeof (options === null || options === void 0 ? void 0 : options.note) === 'string' ? options.note.trim() : '';
        ...
        const configuredPhotosChatId = this.normalizeChatId(photosTarget === null || photosTarget === void 0 ? void 0 : photosTarget.chatId);
        const configuredPhotosTopicId = this.normalizeTopicId(photosTarget === null || photosTarget === void 0 ? void 0 : photosTarget.topicId);
        const previousPhotosChatId = this.normalizeChatId(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_photos_chat_id);
        const previousPhotosTopicId = this.normalizeTopicId(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_photos_topic_id);
        const previousPhotosMessageId = this.toMessageId(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_photos_message_id);
        const previousCommentMessageId = this.toMessageId(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_comment_message_id);
        ...
        try {
            ...
            users = Object.fromEntries(Object.entries(usersRaw).map(([key, value]) => {
                var _a, _b, _c;
                const name = (_b = (_a = value.name) !== null && _a !== void 0 ? _a : value.username) !== null && _b !== void 0 ? _b : '';
                const username = (_c = value.username) !== null && _c !== void 0 ? _c : '';
        ...
        const previousTopicId = this.normalizeTopicId(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_topic_id);
            ...
            try {
                if (previousPlain) {
                    ...
                    if (previousPreviewIds.length) {
                        const previousAttachmentChatId = previousPhotosChatId !== null && previousPhotosChatId !== void 0 ? previousPhotosChatId : normalizedGroupChatId;
                    ...
                    if (previousPhotosMessageId) {
                        const photosChat = previousPhotosChatId !== null && previousPhotosChatId !== void 0 ? previousPhotosChatId : normalizedGroupChatId;
                        if (photosChat) {
                            await this.deleteTaskMessageSafely(photosChat, previousPhotosMessageId, previousPhotosTopicId, previousPhotosTopicId);
                        }
                    }
                }
                const attachmentsChatValue = (_d = configuredPhotosChatId !== null && configuredPhotosChatId !== void 0 ? configuredPhotosChatId : groupChatId) !== null && _d !== void 0 ? _d : normalizedGroupChatId;
                const normalizedAttachmentsChatId = this.normalizeChatId(attachmentsChatValue);
                ...
                previewMessageIds = (_e = sendResult.previewMessageIds) !== null && _e !== void 0 ? _e : [];
                ...
                const consumedUrls = new Set(((_f = sendResult.consumedAttachmentUrls) !== null && _f !== void 0 ? _f : []).filter((url) => Boolean(url)));
                ...
                if (extras.length) {
                    ...
                    if (shouldSendAlbumIntro && normalizedAttachmentsChatId) {
                        const intro = this.buildPhotoAlbumIntro(plain, {
                            messageLink,
                            appLink: taskAppLink !== null && taskAppLink !== void 0 ? taskAppLink : null,
                            topicId: attachmentsTopicIdForSend !== null && attachmentsTopicIdForSend !== void 0 ? attachmentsTopicIdForSend : undefined,
                        });
                        try {
                        ...
                        try {
                            ...
                            if (typeof albumMessageId === 'number' &&
                                ...
                                albumLinkForKeyboard =
                                    (_g = (0, messageLink_1.default)(normalizedAttachmentsChatId, albumMessageId, attachmentsTopicIdForSend)) !== null && _g !== void 0 ? _g : albumLinkForKeyboard;
                            }
                        }
                        catch (error) {
            ...
            try {
                if (typeof baseMessageId === 'number') {
                    ...
                    commentMessageId = await (0, taskComments_1.syncCommentMessage)({
                        ...
                        messageId: previousCommentMessageId !== null && previousCommentMessageId !== void 0 ? previousCommentMessageId : undefined,
                        commentHtml,
                        detectors: {
                ...
                commentMessageId = previousCommentMessageId !== null && previousCommentMessageId !== void 0 ? previousCommentMessageId : undefined;
            }
        }
        else {
            commentMessageId = previousCommentMessageId !== null && previousCommentMessageId !== void 0 ? previousCommentMessageId : undefined;
        ...
        const previousDirectMessages = this.normalizeDirectMessages(previousPlain === null || previousPlain === void 0 ? void 0 : previousPlain.telegram_dm_message_ids);
        ...
        if (assignees.size) {
            const dmKeyboard = (0, bot_1.buildDirectTaskKeyboard)(messageLink, taskAppLink !== null && taskAppLink !== void 0 ? taskAppLink : undefined);
            const dmOptions = {
                parse_mode: 'HTML',
                link_preview_options: { is_disabled: true },
                ...((dmKeyboard === null || dmKeyboard === void 0 ? void 0 : dmKeyboard.reply_markup)
            ...
            for (const userId of assignees) {
                ...
                try {
                    ...
                    if (sent === null || sent === void 0 ? void 0 : sent.message_id) {
                        directMessages.push({
                            user_id: userId,
                    ...
                    if (this.isConversationStartRequiredError(error)) {
                        console.warn(`Пользователь ${userId} ещё не начал диалог с ботом, личное уведомление пропущено`, error);
                        continue;
                    }
...
TasksController = __decorate([
    ...
    __param(0, (0, tsyringe_1.inject)(tokens_1.TOKENS.TasksService)),
    __param(1, (0, tsyringe_1.inject)(tokens_1.TOKENS.ReportGeneratorService)),
    __metadata("design:paramtypes", [Function, reportGenerator_1.default])
], TasksController);
