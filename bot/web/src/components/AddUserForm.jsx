  ...
  return (
    <form onSubmit={submit} className="flex flex-wrap items-end gap-2">
      ...
      <select
        ...
        className="w-44 rounded-lg border border-gray-300 bg-gray-100 px-3 py-2 text-sm text-gray-800 focus:border-brand-500 focus:outline-none focus:ring focus:ring-brand-200 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-100"
      >
