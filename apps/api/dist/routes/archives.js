...
router.get('/', (0, auth_1.default)(), (0, roles_decorator_1.Roles)(ARCHIVE_ACCESS), roles_guard_1.default, (0, express_validator_1.query)('page')
    .optional()
    .isInt({ min: 1 })
    .toInt(), (0, express_validator_1.query)('limit')
    .optional()
    .isInt({ min: 1, max: 200 })
    .toInt(), (0, express_validator_1.query)('search')
    .optional()
    .isString()
    .trim()
    .isLength({ max: 200 }), ctrl.list);
