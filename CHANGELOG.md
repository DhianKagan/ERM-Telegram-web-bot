...
- Удалены дубли страниц `/cp/kanban`, `/cp/reports` и `/cp/routes`; используйте пути `/mg/*`.
...
- Конфигурация Lighthouse CI указывает на каталог `apps/api/public`, исправляя ошибку отсутствия сборки.
