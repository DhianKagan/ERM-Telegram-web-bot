...
32. Значения enum задаются в `apps/api/src/shared/taskFields.ts`, страница справочников удалена
...
71. Списки значений загружаются из `apps/api/src/shared/taskFields.ts` без вызова API
...
106. Функции работы с Google Maps вынесены в общий модуль `apps/api/src/shared/mapUtils.ts`
