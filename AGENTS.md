...
- Коллекция пользователей бота переименована в `telegram_users`, что устраняет
  ошибки при повторной регистрации.
...
- Кнопка создания называется «Новая задача», форма включает мини‑карту со стартовой и финальной точками, выбор типа и возможность тегать пользователей через `@id`.
