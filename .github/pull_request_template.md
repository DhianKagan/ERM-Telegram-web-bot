...
- [ ] Запущен `pnpm run docs:audit`, канонический набор и runbook-ссылки проверены
...
- [ ] При необходимости обновлена документация (README, docs/index, runbook-слой, ROADMAP, CHANGELOG, AGENTS)
