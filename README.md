...
- Веб-панель администратора на `/admin` построена на TailAdmin
  и доступна только пользователям с ролью администратора
- Страница `/roles` позволяет настраивать права ролей
- Маршрут `/admin` использует `/*splat` для совместимости с Express 5
...
- В сообщении указан тип кода: для админа или пользователя
