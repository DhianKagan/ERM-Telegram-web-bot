...
Эти документы поддерживаются как актуальные operational/supporting материалы, но не заменяют канонический набор выше. Railway/admin recovery runbook-материалы должны содержать пометку `Internal-only`, а point-in-time production evidence нужно хранить в archive/internal-only материалах.
...
| Railway / deployment   | [`railway_full_setup.md`](railway_full_setup.md), [`railway_minimal_setup.md`](railway_minimal_setup.md), [`railway_split_services.md`](railway_split_services.md), [`railway_split_release_preflight.md`](railway_split_release_preflight.md), [`railway_s3_setup.md`](railway_s3_setup.md), [`railway_logs.md`](railway_logs.md)                                                                                     | runbook |
...
| [`railway_split_release_preflight.md`](railway_split_release_preflight.md)                           | runbook    | Обязательный preflight перед каждым infra-release Railway split.             |
...
6. Active docs не фиксируют реальные production hostnames, deployment IDs и token-in-command примеры.
