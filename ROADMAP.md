...
15. Пагинация списка задач для уменьшения нагрузки на клиент
16. Автоматическое формирование `slug` для человекочитаемого URL
17. Улучшение SEO и доступности (robots.txt, aria‑label, meta description)
...
109. Перед обновлением зависимостей выполняйте `npm outdated`, затем
