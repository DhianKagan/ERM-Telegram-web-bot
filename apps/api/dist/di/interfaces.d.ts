...
export interface ITasksService {
    get(filters: TaskFilters, page?: number, limit?: number): Promise<TaskDocument[]>;
...
export interface IUsersService {
    ...
    create(id: string | number | undefined, username?: string, roleId?: string, data?: unknown): Promise<unknown>;
