...
const buildUsersIndex = async (ids) => {
    ...
    try {
        ...
        const entries = Object.entries(raw !== null && raw !== void 0 ? raw : {}).map(([key, value]) => {
            const name = selectUserField(value === null || value === void 0 ? void 0 : value.name) || selectUserField(value === null || value === void 0 ? void 0 : value.username);
            const username = selectUserField(value === null || value === void 0 ? void 0 : value.username);
            return [
                key,
                { name, username },
            ];
...
let TaskSyncController = class TaskSyncController {
    ...
    async updateTaskMessage(taskId, override) {
        ...
        const topicId = (_a = toNumericId(task.telegram_topic_id)) !== null && _a !== void 0 ? _a : (typeof configuredTopicId === 'number' ? configuredTopicId : null);
        ...
        const chatIdForLinks = normalizedGroupChatId !== null && normalizedGroupChatId !== void 0 ? normalizedGroupChatId : (typeof targetChatId === 'string' || typeof targetChatId === 'number'
            ? targetChatId
            : undefined);
        ...
        const configuredPhotosChatId = normalizeChatId(photosTarget === null || photosTarget === void 0 ? void 0 : photosTarget.chatId);
        const configuredPhotosTopicId = (_b = toNumericId(photosTarget === null || photosTarget === void 0 ? void 0 : photosTarget.topicId)) !== null && _b !== void 0 ? _b : undefined;
        ...
        let commentMessageId = previousCommentMessageId !== null && previousCommentMessageId !== void 0 ? previousCommentMessageId : undefined;
        ...
        const ensurePreviousMediaRemoved = async () => {
            ...
            const attachmentsChatId = previousPhotosChatId !== null && previousPhotosChatId !== void 0 ? previousPhotosChatId : targetChatId;
        ...
        const editReplyMarkup = typeof ((_d = (_c = this.bot) === null || _c === void 0 ? void 0 : _c.telegram) === null || _d === void 0 ? void 0 : _d.editMessageReplyMarkup) === 'function'
        ...
        if (currentMessageId === null) {
            try {
                const attachmentsChatValue = (_e = configuredPhotosChatId !== null && configuredPhotosChatId !== void 0 ? configuredPhotosChatId : targetChatId) !== null && _e !== void 0 ? _e : normalizedGroupChatId;
                ...
                previewMessageIds = (_f = sendResult.previewMessageIds) !== null && _f !== void 0 ? _f : [];
                ...
                if (sentMessageId) {
                    ...
                    const consumed = new Set((_g = sendResult.consumedAttachmentUrls) !== null && _g !== void 0 ? _g : []);
                            ...
                            try {
                                ...
                                if (response === null || response === void 0 ? void 0 : response.message_id) {
                                    ...
                                    albumLinkForKeyboard =
                                        (_h = (0, messageLink_1.default)(normalizedAttachmentsChatId, albumMessageId, attachmentsTopicIdForSend)) !== null && _h !== void 0 ? _h : albumLinkForKeyboard;
                                }
                            }
                            catch (error) {
                                ...
                                if (typeof albumMessageId === 'number' &&
                                    ...
                                    photosTopicId =
                                        typeof attachmentsTopicIdForSend === 'number'
                                            ...
                                            : undefined;
                                    albumLinkForKeyboard =
                                        (_j = (0, messageLink_1.default)(normalizedAttachmentsChatId, albumMessageId, attachmentsTopicIdForSend)) !== null && _j !== void 0 ? _j : albumLinkForKeyboard;
                                }
                            }
                            catch (error) {
            ...
            if ((_k = media.previewImage) === null || _k === void 0 ? void 0 : _k.url) {
            ...
            if (attachmentsToSend.length) {
                const attachmentsChatValue = (_l = configuredPhotosChatId !== null && configuredPhotosChatId !== void 0 ? configuredPhotosChatId : targetChatId) !== null && _l !== void 0 ? _l : normalizedGroupChatId;
                const normalizedAttachmentsChatId = normalizeChatId(attachmentsChatValue);
                ...
                if (shouldSendAlbumIntro && normalizedAttachmentsChatId) {
                    ...
                    try {
                        ...
                        if (response === null || response === void 0 ? void 0 : response.message_id) {
                            albumMessageId = response.message_id;
                            albumLinkForKeyboard =
                                (_m = (0, messageLink_1.default)(normalizedAttachmentsChatId, albumMessageId, attachmentsTopicIdForSend)) !== null && _m !== void 0 ? _m : albumLinkForKeyboard;
                        }
                    }
                    catch (error) {
                        console.error('Не удалось отправить описание альбома задачи', error);
                    ...
                    try {
                        const sentIds = await this.mediaHelper.sendTaskAttachments(attachmentsChatValue, attachmentsToSend, attachmentsTopicIdForSend, albumMessageId
                            ...
                            : shouldReplyToGroup
                                ? sentMessageId
                                : undefined);
                        const previewCount = ((_o = media.previewImage) === null || _o === void 0 ? void 0 : _o.url) ? 1 : 0;
                        if (previewCount > 0) {
                        ...
                        if (typeof albumMessageId === 'number' &&
                            ...
                            photosTopicId =
                                typeof attachmentsTopicIdForSend === 'number'
                                    ...
                                    : undefined;
                            albumLinkForKeyboard =
                                (_p = (0, messageLink_1.default)(normalizedAttachmentsChatId, albumMessageId, attachmentsTopicIdForSend)) !== null && _p !== void 0 ? _p : albumLinkForKeyboard;
                        }
                    }
                    catch (error) {
        ...
        if (shouldDeletePreviousComment &&
        ...
        if (typeof baseMessageId === 'number') {
            ...
            try {
                ...
                if (isMessageMissingOnDeleteError(error)) {
                    ...
                    commentMessageId = previousCommentMessageId !== null && previousCommentMessageId !== void 0 ? previousCommentMessageId : commentMessageId;
                }
            }
        }
        const setPayload = {};
