...
- После создания задачи список на странице `/tasks` обновляется автоматически,
  ...
  - Карта расположена над фильтрами, выбранные даты отображаются в шапке календаря
  - Справа показан список задач в выбранном диапазоне
  ...
  - Календарь всплывает поверх интерфейса,
