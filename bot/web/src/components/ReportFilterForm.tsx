  ...
  return (
    <form onSubmit={submit} className="flex flex-wrap items-end gap-2">
      <input
        ...
        className="rounded-lg border border-gray-300 bg-gray-100 px-3 py-2 text-sm text-gray-800 focus:border-accentPrimary focus:outline-none focus:ring focus:ring-brand-200"
      />
      <input
        type="date"
        value={to}
