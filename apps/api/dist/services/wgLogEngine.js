...
const defaultBufferSize = Number((_a = process.env.LOG_BUFFER_SIZE) !== null && _a !== void 0 ? _a : 2000);
class LogRingBuffer {
    ...
    list(params = {}) {
        const normalizedLevel = typeof params.level === 'string' &&
            allowedLevels.has(params.level)
            ? params.level
            : undefined;
...
function buildLogger() {
        ...
        hooks: {
            logMethod(args, method) {
                ...
                const label = typeof methodLevel === 'number'
                    ? ((_a = pino_1.default.levels.labels[methodLevel]) !== null && _a !== void 0 ? _a : 'info')
                    : 'info';
                ...
                const trace = (0, trace_1.getTrace)();
                const finalLevel = (_b = payload.levelOverride) !== null && _b !== void 0 ? _b : normalized;
    ...
    const targets = [];
    const logDir = (_a = process.env.LOG_DIR) !== null && _a !== void 0 ? _a : node_path_1.default.resolve(process.cwd(), 'logs');
    const fileName = (_b = process.env.LOG_FILE_NAME) !== null && _b !== void 0 ? _b : 'api.log';
...
if (loggingDisabled) {
    ...
    exports.writeLog = writeLogFn = async (message, level = 'info', metadata = {}) => {
        ...
        const sanitizedMetadata = (_a = sanitizeValue(metadata)) !== null && _a !== void 0 ? _a : undefined;
        if (sanitizedMetadata) {
            sanitizedMetadata[levelToken] =
                normalizedLevel;
        ...
        await notifySideChannels(normalizedLevel, {
            ...
            traceId: (_b = (0, trace_1.getTrace)()) === null || _b === void 0 ? void 0 : _b.traceId,
        });
    };
