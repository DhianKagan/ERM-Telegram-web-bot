...
4. Запустите контейнеры:
   ...
   Мини‑приложение будет доступно по команде бота.
...
2. Задайте рабочую директорию `bot`.
3. Укажите Node `18` и переменные окружения из `.env.example`.
4. Бот запускается из `src/bot/bot.js` командой `npm start`.
