...
const ctrl = __importStar(require("../controllers/analytics"));
const validate_1 = __importDefault(require("../utils/validate"));
const router = (0, express_1.Router)();
router.get('/route-plans/summary', (0, auth_1.default)(), ...(0, validate_1.default)([
...
]), (0, middleware_1.asyncHandler)(ctrl.routePlanSummary));
