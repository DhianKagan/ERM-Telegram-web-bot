...
async function sendCode(telegramId) {
    ...
    const roleId = (_a = user === null || user === void 0 ? void 0 : user.roleId) === null || _a === void 0 ? void 0 : _a.toString();
...
async function verifyCode(id, code, username) {
    ...
    let roleId = (_a = user === null || user === void 0 ? void 0 : user.roleId) === null || _a === void 0 ? void 0 : _a.toString();
    const adminRoleId = await (0, roleCache_1.resolveRoleId)('admin');
    ...
    if (roleId === adminRoleIdString || otp.adminCodes.has(telegramId)) {
        ...
        if (verified && user && roleId !== adminRoleIdString) {
            ...
            roleId = adminRoleIdString !== null && adminRoleIdString !== void 0 ? adminRoleIdString : undefined;
        }
    }
    else {
    ...
    if (!u) {
        ...
        roleId = ((_b = u.roleId) === null || _b === void 0 ? void 0 : _b.toString()) || roleId;
    }
    const managerRoleId = await (0, roleCache_1.resolveRoleId)('manager');
