...
71. Страница маршрутов отображает путь через OSRM:
    карта находится над фильтрами,
    выбранные даты показаны в шапке календаря,
    справа выводятся задачи выбранного периода
72. Dockerfile копирует каталог `bot/`, сборка образа успешна
73. На странице «Маршруты» календарь отображается во всплывающем окне,
    фильтры статуса и отдела удалены,
    задачи выводятся таблицей с сортировкой и фильтрами,
    админ открывает их на редактирование
