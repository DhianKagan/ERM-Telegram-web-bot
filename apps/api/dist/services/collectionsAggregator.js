...
const applyTaskFieldDefaults = (item, order, defaults) => {
    var _a;
    const meta = (_a = item.meta) !== null && _a !== void 0 ? _a : {};
    item.meta = {
        ...meta,
        order,
...
const ensureTaskTypeItems = (items) => {
    ...
    items
        ...
        .forEach((item) => {
        var _a;
        const order = (_a = TASK_TYPE_ORDER.get(item.name)) !== null && _a !== void 0 ? _a : shared_1.TASK_TYPES.length;
...
async function listCollectionsWithLegacy(filters = {}, page = 1, limit = 20) {
    ...
    items.forEach((item) => {
        ...
        (_a = byTypeName.get(item.type)) === null || _a === void 0 ? void 0 : _a.add(item.name);
        (_b = byTypeId.get(item.type)) === null || _b === void 0 ? void 0 : _b.add(item._id);
    });
    ...
    if (shouldIncludeLegacyType(typeFilter)) {
        if (!typeFilter || typeFilter === 'departments') {
            ...
            const existingNames = (_a = byTypeName.get('departments')) !== null && _a !== void 0 ? _a : new Set();
            const existingIds = (_b = byTypeId.get('departments')) !== null && _b !== void 0 ? _b : new Set();
        ...
        if (!typeFilter || typeFilter === 'employees') {
            ...
            const existingNames = (_c = byTypeName.get('employees')) !== null && _c !== void 0 ? _c : new Set();
            const existingIds = (_d = byTypeId.get('employees')) !== null && _d !== void 0 ? _d : new Set();
    ...
    const filtered = items
        ...
        if (a.type === 'task_fields' && b.type === 'task_fields') {
            return compareByOrder((_a = a.meta) === null || _a === void 0 ? void 0 : _a.order, (_b = b.meta) === null || _b === void 0 ? void 0 : _b.order);
        }
        if (a.type === 'task_types' && b.type === 'task_types') {
            return compareByOrder((_c = a.meta) === null || _c === void 0 ? void 0 : _c.order, (_d = b.meta) === null || _d === void 0 ? void 0 : _d.order);
        }
