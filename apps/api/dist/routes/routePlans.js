...
router.patch('/:id/status', (0, auth_1.default)(), ...(0, validate_1.default)([(0, express_validator_1.body)('status').isIn(['draft', 'approved', 'completed'])]), (0, middleware_1.asyncHandler)(ctrl.changeStatus));
