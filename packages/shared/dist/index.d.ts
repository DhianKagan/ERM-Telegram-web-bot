...
export type { Task, User, FleetVehicleDto, TrackingAlarmEvent, TrackingAlarmSeverity, TrackingAlarmType, TrackingEvent, TrackingHeartbeatEvent, TrackingInitEvent, TrackingPositionEvent, RoutePlan, RoutePlanMetrics, RoutePlanRoute, RoutePlanRouteMetrics, RoutePlanStop, RoutePlanTaskRef, RoutePlanStatus, RoutePlanAnalyticsSummary, RoutePlanAnalyticsSeriesPoint, RoutePlanAnalyticsSlaPoint, LogisticsEvent, LogisticsEventBase, LogisticsTasksChangedEvent, LogisticsRoutePlanUpdatedEvent, LogisticsRoutePlanRemovedEvent, LogisticsInitEvent, LogisticsHeartbeatEvent, } from './types';
