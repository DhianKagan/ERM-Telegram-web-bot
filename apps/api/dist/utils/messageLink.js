...
exports.buildChatMessageLink = buildChatMessageLink;
function buildChatMessageLink(chatIdValue, messageIdValue, topicIdValue) {
    ...
    const buildUrl = (base) => topicId !== null ? `${base}/${topicId}/${messageId}` : `${base}/${messageId}`;
...
exports.default = buildChatMessageLink;
