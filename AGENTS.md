...
```
Контекст: <кратко об архитектуре и затронутых модулях>.
Изменения: <ключевые правки, указать файлы/пакеты>.
Контракты: <подтвердить соблюдение требований из AGENTS.md и docs/architecture.md>.
Инварианты: <указать проверенные инварианты и результаты>.
Риски: <что может пойти не так, какие тесты нужны>.
