...
function resolveTaskAlbumLink(source, context = {}) {
    ...
    const targetChatId = explicitChatId !== null && explicitChatId !== void 0 ? explicitChatId : fallbackChatId;
    if (!targetChatId) {
        return null;
    }
    ...
    const topicIdForLink = explicitTopicId !== null && explicitTopicId !== void 0 ? explicitTopicId : (fallbackTopicId &&
        (!explicitChatId || !fallbackChatId || explicitChatId === fallbackChatId)
        ? fallbackTopicId
        : null);
    return ((_a = (0, messageLink_1.default)(targetChatId, messageIdNumeric, topicIdForLink !== null && topicIdForLink !== void 0 ? topicIdForLink : undefined)) !== null && _a !== void 0 ? _a : null);
}
