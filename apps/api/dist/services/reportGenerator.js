...
const resolveFontStore = (fonts) => {
    ...
    if (typeof fonts === 'object' && fonts !== null) {
        const module = fonts;
        const vfs = (_a = module.pdfMake) === null || _a === void 0 ? void 0 : _a.vfs;
        if (isFontRecord(vfs)) {
            return vfs;
        }
    }
...
class ReportGeneratorService {
    ...
    async fetchTasks(filters, user) {
        ...
        const userId = (user === null || user === void 0 ? void 0 : user.id) != null ? String(user.id) : '';
    ...
    isManager(user) {
        const role = typeof (user === null || user === void 0 ? void 0 : user.role) === 'string' ? user.role.trim() : '';
        if (role === 'admin' || role === 'manager') {
            return true;
        }
        const mask = typeof (user === null || user === void 0 ? void 0 : user.access) === 'number' ? user.access : 0;
    ...
    resolveNumber(task) {
        var _a, _b, _c;
        const number = (_c = (_b = (_a = task.task_number) !== null && _a !== void 0 ? _a : task.request_id) !== null && _b !== void 0 ? _b : task.id) !== null && _c !== void 0 ? _c : task._id;
        if (typeof number === 'string' && number.trim()) {
            return number.trim();
        }
        return String(number !== null && number !== void 0 ? number : '');
    }
    resolveTitle(task) {
