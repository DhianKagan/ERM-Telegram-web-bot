...
Каталог `bot` содержит актуальную логику бота и мини‑приложение. Каталог `bot_old` оставлен для истории.
...
1. Склонируйте текущий репозиторий с модифицированным кодом:
 ...
 Исходники прежней версии находятся в `bot_old`. Актуальная версия находится в каталоге `bot`.
