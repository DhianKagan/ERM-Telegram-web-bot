...
23. Редактирование отделов через `/api/v1/departments`, имена проходят проверку типа
24. Обновление отделов выполняется через `$set`, чтобы избежать лишних условий
25. Улучшение интерфейса управления заявками
