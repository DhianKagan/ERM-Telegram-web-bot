...
- Страница «Маршруты» строит путь через OSRM,
  фильтр по времени выбирается календарём
- Карта размещена над фильтрами, диапазон дат виден в заголовке календаря
- Справа отображается список задач в выбранном диапазоне
- Календарь всплывает поверх элементов, убраны фильтры статуса и отдела
- Задачи на странице «Маршруты» показаны таблицей с сортировкой и фильтрами,
