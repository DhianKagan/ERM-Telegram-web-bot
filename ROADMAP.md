...
12. Универсальная модель `UniversalTask` для сложных заявок
13. Поддержка enum-полей для типов транспорта, оплаты и статусов
14. CRUD-эндпойнты `/api/universal_tasks` и универсальная форма заявки
...
19. Отдельная страница управления универсальными заявками
