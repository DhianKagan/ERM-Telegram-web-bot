...
const messages = {
    ...
    taskCancelForbidden: 'Статус «Отменена» может установить только создатель задачи.',
    requestCancelExecutorOnly: 'Отменить заявку могут только исполнитель или создатель.',
    taskHistoryEmpty: 'История изменений отсутствует.',
    taskHistoryPopupError: 'Не удалось загрузить историю задачи.',
    cancelRequestPrompt: 'Отправьте причину удаления задачи личным сообщением боту.',
    cancelRequestStartError: 'Не удалось отправить запрос на отмену. Напишите боту в личные сообщения.',
    cancelRequestCreatorMissing: 'Не удалось определить автора задачи для назначения запроса.',
    cancelRequestUnavailable: 'Запрос на отмену можно создать только для задач.',
    cancelRequestReasonLength: 'Причина удаления должна содержать не менее 50 символов.',
    cancelRequestConfirmPrompt: 'Проверьте текст причины удаления и подтвердите отправку запроса.',
    ...
    commentStartError: 'Не удалось начать ввод комментария. Напишите боту в личные сообщения.',
    ...
    taskCompletedLock: 'Задача уже выполнена. Изменение статуса доступно только через веб-интерфейс после отмены.',
};
