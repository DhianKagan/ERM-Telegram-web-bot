...
- Добавлено кеширование задач в Redis и эндпойнт `/metrics` для Prometheus
...
- Добавлено требование запустить Redis отдельным контейнером `docker run -d --name redis -p 6379:6379 redis:alpine`
