...
router.post(
  ...
  ...validate([
    ...
    body('creatorId').optional({ nullable: true }).isInt(),
    body('executorId').optional({ nullable: true }).isInt(),
    body('companyPointIds').optional().isArray(),
    body('companyPointIds.*').optional().isString(),
    body('transportId').optional({ nullable: true }).isString(),
    body('transportName').optional({ nullable: true }).isString(),
    body('tasks').optional().isArray(),
    body('tasks.*').optional().isString(),
