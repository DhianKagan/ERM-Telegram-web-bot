...
- Добавлена роль «manager» с маской доступа 4, поля департамент, отдел и
  должность для пользователей и сотрудников; менеджерам открыт слой
  `/mg/` с Канбаном, отчётами и маршрутами.
