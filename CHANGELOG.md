...
- В конфигурации добавлена проверка на стандартные ADMIN_EMAIL и ADMIN_PASSWORD, README напоминает заменить их перед релизом.
- README получил оглавление, раздел возможностей и пример API-запроса.
