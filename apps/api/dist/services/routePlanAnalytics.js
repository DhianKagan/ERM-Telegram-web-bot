...
const extractParts = (date) => {
    ...
    const year = Number((_b = (_a = parts.find((part) => part.type === 'year')) === null || _a === void 0 ? void 0 : _a.value) !== null && _b !== void 0 ? _b : 0);
    const month = Number((_d = (_c = parts.find((part) => part.type === 'month')) === null || _c === void 0 ? void 0 : _c.value) !== null && _d !== void 0 ? _d : 1);
    const day = Number((_f = (_e = parts.find((part) => part.type === 'day')) === null || _e === void 0 ? void 0 : _e.value) !== null && _f !== void 0 ? _f : 1);
...
async function fetchRoutePlanAnalytics(filters) {
    ...
    for (const plan of plans) {
        ...
        const distance = Number((_b = (_a = plan.metrics) === null || _a === void 0 ? void 0 : _a.totalDistanceKm) !== null && _b !== void 0 ? _b : 0);
        if (Number.isFinite(distance) && distance > 0) {
            totalMileage += distance;
            mileageByDay.set(key, ((_c = mileageByDay.get(key)) !== null && _c !== void 0 ? _c : 0) + distance);
        }
        const routes = Array.isArray(plan.routes) ? plan.routes : [];
        for (const route of routes) {
            const load = Number((_e = (_d = route.metrics) === null || _d === void 0 ? void 0 : _d.load) !== null && _e !== void 0 ? _e : Number.NaN);
            if (Number.isFinite(load) && load > 0) {
                const entry = (_f = loadByDay.get(key)) !== null && _f !== void 0 ? _f : { sum: 0, count: 0 };
                entry.sum += load;
                entry.count += 1;
        ...
        if (dropoffs.length) {
            ...
            for (const stop of dropoffs) {
                const delay = Number((_g = stop.delayMinutes) !== null && _g !== void 0 ? _g : 0);
                if (!Number.isFinite(delay) || delay <= 0) {
                    onTime += 1;
                }
            }
            const entry = (_h = slaByDay.get(key)) !== null && _h !== void 0 ? _h : { onTime: 0, total: 0 };
            entry.onTime += onTime;
    ...
    const mileageSeries = resultKeys.map((key) => {
        var _a;
        const value = (_a = mileageByDay.get(key)) !== null && _a !== void 0 ? _a : 0;
