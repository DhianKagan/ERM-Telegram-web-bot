...
40. В логах разработки выводить только начало `BOT_TOKEN`
41. Указать рабочий email в SECURITY.md и владельца в CODEOWNERS
42. Обновить документацию: приоритет по умолчанию — «В течение дня»
