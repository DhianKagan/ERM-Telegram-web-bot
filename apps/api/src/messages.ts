...
const messages = {
  ...
  cancelRequestStartError:
    'Не удалось отправить запрос на удаление. Напишите боту в личные сообщения.',
  cancelRequestCreatorMissing:
    'Не удалось определить автора задачи для назначения заявки.',
  cancelRequestUnavailable:
    'Заявку на удаление можно создать только для задач.',
  cancelRequestReasonLength:
    'Причина удаления должна содержать не менее 50 символов.',
  cancelRequestConfirmPrompt:
    'Проверьте текст причины удаления и подтвердите создание заявки.',
  cancelRequestCanceled: 'Создание заявки на удаление отменено.',
  cancelRequestSuccess: 'Заявка на удаление задачи создана.',
  cancelRequestFailed: 'Не удалось создать заявку на удаление задачи.',
