...
export declare function optimize(tasks: OptimizeTaskInput[], options: OptimizeOptions): Promise<OptimizeResult>;
export declare function optimize(taskIds: string[], count?: number, method?: OptimizeMethod, actorId?: number): Promise<SharedRoutePlan | null>;
