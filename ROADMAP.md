...
- Реализованы CRUD‑роуты для флотов, департаментов, сотрудников и коллекций.
- Добавлена модель CollectionItem с поиском и пагинацией через репозиторий.
- Управление сотрудниками, департаментами, флотами и ролями с поиском и пагинацией вынесено на страницу `/cp/settings`,
