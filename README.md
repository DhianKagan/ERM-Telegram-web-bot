...
Каталог `bot` снова содержит рабочий код бота, перенесённый из `bot_old`.
Каталог `bot_old` сохранён для истории и сравнений.
...
1. Склонируйте текущий репозиторий с модифицированным кодом:
   ...
   ```
  Исходники прежней версии находятся в `bot_old`; основной код теперь находится в `bot`.
