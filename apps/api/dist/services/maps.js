...
const normalizeNominatimItem = (item) => {
    ...
    const lngValue = lonCandidate !== null && lonCandidate !== void 0 ? lonCandidate : lngCandidate;
    ...
    if (!normalized) {
        return {
            id: String((_a = item.place_id) !== null && _a !== void 0 ? _a : `${lat},${lng}`),
    ...
    return {
        id: String((_b = item.place_id) !== null && _b !== void 0 ? _b : `${lat},${lng}`),
...
const searchAddress = async (query, options = {}) => {
    ...
    const limit = Math.min(Math.max((_a = options.limit) !== null && _a !== void 0 ? _a : 5, 1), 10);
