...
97. Все запросы к API и ответы фиксируются в журнале
98. Бот сравнивает текст перед редактированием сообщений
99. Поля описания задач и комментариев ограничены 4096 символами
100. Описание задачи видно в форме при закрытом редакторе
