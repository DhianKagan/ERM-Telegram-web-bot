...
async function checkTaskAccess(req, res, next) {
    ...
    const mask = (_b = (_a = req.user) === null || _a === void 0 ? void 0 : _a.access) !== null && _b !== void 0 ? _b : accessMask_1.ACCESS_USER;
    const id = Number((_c = req.user) === null || _c === void 0 ? void 0 : _c.id);
    ...
    const routePath = typeof ((_d = req.route) === null || _d === void 0 ? void 0 : _d.path) === 'string' ? req.route.path : '';
    ...
    if (isTaskUpdateRoute) {
        ...
        if (isExecutor && !isCreator) {
            const payload = ((_e = req.body) !== null && _e !== void 0 ? _e : {});
    ...
    await (0, service_1.writeLog)(`Нет доступа ${req.method} ${req.originalUrl} user:${id}/${(_f = req.user) === null || _f === void 0 ? void 0 : _f.username} ip:${req.ip}`).catch(() => { });
