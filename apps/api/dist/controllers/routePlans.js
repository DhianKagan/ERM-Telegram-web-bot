...
const normalizeRoutesPayload = (routes) => {
    ...
    return routes
        ...
        else if (typeof rawDriverId === 'number' &&
...
async function update(req, res) {
    ...
    const payload = {
        ...
        notes: ((_b = req.body) === null || _b === void 0 ? void 0 : _b.notes) === null || typeof ((_c = req.body) === null || _c === void 0 ? void 0 : _c.notes) === 'string'
            ? (_d = req.body) === null || _d === void 0 ? void 0 : _d.notes
            : undefined,
        routes: normalizeRoutesPayload((_e = req.body) === null || _e === void 0 ? void 0 : _e.routes),
    };
...
async function changeStatus(req, res) {
    ...
    const statusValue = (_a = req.body) === null || _a === void 0 ? void 0 : _a.status;
    const status = (typeof statusValue === 'string' ? statusValue.trim() : statusValue);
    const actorId = parseActorId((_b = req.user) === null || _b === void 0 ? void 0 : _b.id);
