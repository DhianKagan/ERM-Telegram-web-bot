...
const resolveStatusStyle = (value) => {
    ...
    return (_a = STATUS_COLOR_MAP[trimmed]) !== null && _a !== void 0 ? _a : null;
};
...
const emphasizeValue = (value, style, options = {}) => {
    var _a, _b, _c;
    const emojiCandidate = ((_a = style === null || style === void 0 ? void 0 : style.fill) === null || _a === void 0 ? void 0 : _a.color)
        ? pickColorEmoji(style.fill.color)
        : null;
    const emoji = (_c = (_b = options.fallbackEmoji) !== null && _b !== void 0 ? _b : emojiCandidate) !== null && _c !== void 0 ? _c : '';
...
const renderNode = (node, context) => {
    ...
    switch (name) {
        ...
        case 'a': {
            const href = (_c = (_b = element.attribs) === null || _b === void 0 ? void 0 : _b.href) === null || _c === void 0 ? void 0 : _c.trim();
...
const extractInlineImages = (html) => {
    ...
    const cleanedHtml = html.replace(/<img\b[^>]*>/gi, (tag) => {
        ...
        const rawSrc = (srcMatch === null || srcMatch === void 0 ? void 0 : srcMatch[2]) || (srcMatch === null || srcMatch === void 0 ? void 0 : srcMatch[3]) || (srcMatch === null || srcMatch === void 0 ? void 0 : srcMatch[4]) || '';
        ...
        const rawAlt = (altMatch === null || altMatch === void 0 ? void 0 : altMatch[2]) || (altMatch === null || altMatch === void 0 ? void 0 : altMatch[3]) || (altMatch === null || altMatch === void 0 ? void 0 : altMatch[4]) || '';
...
const buildTaskLink = (task) => {
    var _a;
    const canonicalId = (_a = toIdentifier(task._id)) !== null && _a !== void 0 ? _a : toIdentifier(task.request_id);
    if (!canonicalId)
        return null;
...
function formatTask(task, users = {}) {
    ...
    const logisticsEnabled = typeof task.logistics_enabled === 'boolean' ? task.logistics_enabled : true;
    ...
    if (logisticsEnabled) {
        ...
        if (task.route_distance_km !== undefined &&
    ...
    if (Array.isArray(task.assignees) && task.assignees.length) {
        const links = task.assignees
            .map((id) => { var _a, _b; return (0, userLink_1.default)(id, ((_a = users[id]) === null || _a === void 0 ? void 0 : _a.name) || ((_b = users[id]) === null || _b === void 0 ? void 0 : _b.username)); })
            .join(', ');
    ...
    if (task.created_by) {
        peopleLines.push(`👤 Создатель: ${(0, userLink_1.default)(task.created_by, ((_a = users[task.created_by]) === null || _a === void 0 ? void 0 : _a.name) || ((_b = users[task.created_by]) === null || _b === void 0 ? void 0 : _b.username))}`);
    }
