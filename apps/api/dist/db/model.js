...
exports.ShortLink = exports.Log = exports.TaskTemplate = exports.TaskDraft = exports.File = exports.User = exports.Role = exports.Archive = exports.TaskHistoryArchive = exports.Task = void 0;
...
taskSchema.pre('validate', function syncLegacyPoints() {
    var _a, _b, _c, _d, _e, _f;
    if (Array.isArray(this.points) && this.points.length) {
        const startPoint = (_a = this.points.find((p) => p.kind === 'start')) !== null && _a !== void 0 ? _a : this.points[0];
        const finishPoint = (_b = [...this.points].reverse().find((p) => p.kind === 'finish')) !== null && _b !== void 0 ? _b : this.points[this.points.length - 1];
        if (startPoint === null || startPoint === void 0 ? void 0 : startPoint.coordinates) {
            this.startCoordinates = startPoint.coordinates;
            if (!this.start_location && startPoint.title) {
                this.start_location = startPoint.title;
            }
        }
        if (finishPoint === null || finishPoint === void 0 ? void 0 : finishPoint.coordinates) {
    ...
    if (this.startCoordinates) {
        points.push({
            ...
            title: (_c = this.start_location) !== null && _c !== void 0 ? _c : undefined,
            sourceUrl: (_d = this.google_route_url) !== null && _d !== void 0 ? _d : undefined,
        });
    }
    if (this.finishCoordinates) {
        points.push({
            ...
            title: (_e = this.end_location) !== null && _e !== void 0 ? _e : undefined,
            sourceUrl: (_f = this.google_route_url) !== null && _f !== void 0 ? _f : undefined,
        });
    }
    if (points.length) {
        this.points = points;
...
taskSchema.pre('save', async function () {
    ...
    if (!this.request_id) {
        ...
        const latestNumber = (_a = stats === null || stats === void 0 ? void 0 : stats.max) !== null && _a !== void 0 ? _a : 0;
...
exports.Log = mongoose_1.default.model('Log', new mongoose_1.Schema({
    message: String,
