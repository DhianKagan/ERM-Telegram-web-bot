...
## [0.2.0] - 2025-06-22
- Переписан фронтенд на React + Vite.
- Подключена документация Swagger по адресу `/api-docs`.
- Добавлены Husky и CI с запуском тестов и линтера.
- Скрипты `npm run migrate` и `npm run seed`.
- Админ-панель с просмотром пользователей и логов.
